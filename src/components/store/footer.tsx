  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-contact">
        ...
        {/* EMAIL */}
        <a href="mailto:wecare@eviola.com" className="contact-row">
          <svg viewBox="0 0 24 24" fill="none" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="footer-links">
        ...
        <div className="footer-col">
          ...
          <ul>
            <li>
              <a href="https://eviola.in/about-us-page">About Us</a>
            </li>
            <li>
      ...
      <div className="footer-social">
        ...
        {/* Instagram */}
        <a
          href="https://www.instagram.com/eviola.in/"
        ...
        >
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle className="instagram-dot" cx="17.5" cy="6.5" r="1.15" />
          </svg>
        </a>
      ...
      */}
      <style>{`
        ...
        /* Equal background size for every icon */
        .social-icon {
          width: 28px;
          height: 28px;
          min-width: 28px;
