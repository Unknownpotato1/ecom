      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        ...
        <div className="mt-auto pt-3">
          ...
          {/* "Get it for ₹XX" — 20% off the selling price. Pink bar that
              ...
              When compact=true (homepage collection carousel where only 2.25
              cards are visible and space is tight), the sparkles icon is
              omitted so "Get it for ₹XX" fits on a single line. */}
          {product.price > 0 && (
            <div
            ...
            >
              {/* Sparkles/badge icon — draws attention to the offer.
                  Hidden in compact mode to save horizontal space. */}
              {!compact && (
                <svg
