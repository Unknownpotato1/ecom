  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 fade-up">
      ...
      <nav className="flex items-center gap-1 text-xs text-muted-foreground mb-5">
        ...
        <span>{product.category || 'Hampers'}</span>
        <ChevronRight className="h-3 w-3" />
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-3">
          <div className="relative aspect-square rounded-xl overflow-hidden bg-pink-50 border border-pink-100">
            ...
            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
              {product.images.map((img, i) => (
                <button
                  ...
                  className={cn(
                    'h-16 w-16 rounded-md overflow-hidden border-2 shrink-0',
                    i === activeImage ? 'border-brand' : 'border-pink-100'
                  )}
                >
                  { }
